...
<div class="content">
    <div class="description" style="padding: 15px">
        <h4 style="display: inline; text-align: left">Current weight: <?=$current_weight?></h4>
        <span style="float: right;">
            <a href="#add_weight_modal" data-transition="slide-out" class="btn btn-positive">Update</a>
        </span>
    </div>
